...
public class PalindromStream {
	static Logger logger = Logger.getLogger(PalindromStream.class.getName());
	...
	public static void main(String[] args) {
		...
		word = sc.next();
		/*
		 * for(int i=word.length()-1;i>=0;i--) { bl.append(word.charAt(i));
		 * 
		 * } String reverse=bl.toString(); if(word.equalsIgnoreCase(reverse)) {
